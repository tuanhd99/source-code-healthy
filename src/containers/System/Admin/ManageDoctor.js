...
class ManageDoctor extends Component {
  ...
  componentDidMount() {
    ...
    this.props.getRequiredDoctoInfor();
  }
  /* life cycle (vong doi)
  Run component
...
*/
  ...
  handleOnchangSelectDoctorInfor = async (selectedOption, name) => {
        ...
        <div className="doctor-infor-extra row">
          <div className="col-4 form-group">
            ...
            <Select
              ...
              onChange={this.handleOnchangSelectDoctorInfor}
        ...
        <div className="row">
          ...
          <div className="col-4 form-group">
            ...
            <Select
              ...
              placeholder={
                <FormattedMessage id="admin.manage-doctor.select-clinic"></FormattedMessage>
              }
              name="selectedClinic"
            />
          </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    fetchAllDoctors: (id) => dispatch(action.fetchAllDoctors()),
